...
namespace FM.Effects
{
    ...
    public class DanTrail : IDisposable
    {
        ...
        /// <summary>
        /// Used in order to calculate the normal from the froFMost position, because there isn't a point after it in the original list.
        /// </summary>
        public Vector2 NextPosition { get; set; }

        private const float defaultWidth = 16;

        public DanTrail(GraphicsDevice device, int maxPointCount, ITrailTip tip, TrailWidthFunction trailWidthFunction, TrailColorFunction trailColorFunction)
        {
