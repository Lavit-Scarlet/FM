...
namespace FM.Assets.Backgrounds.Skies
{
    public class ArmagemSky : CustomSky
    {
        public bool Active;
        public float Intensity;
        public float ScaleY = 1.8f;
        ...
        {
            Texture2D SkyTex = ModContent.Request<Texture2D>("FM/Assets/Backgrounds/Skies/SkyTex").Value;
            if (GrooveTimer == 0)
            {
                ScaleY -= 0f;
                if (ScaleY <= 1f)
