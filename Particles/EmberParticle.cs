...
namespace FM.Particles
{
    public class EmberParticle : Particle
    {
        ...
        {
            Texture2D circle = ModContent.Request<Texture2D>("FM/Assets/Textures/Circle").Value;
            Texture2D ember = ModContent.Request<Texture2D>("FM/Particles/EmberParticle").Value;
            Texture2D glow = ModContent.Request<Texture2D>("FM/Assets/Textures/SoftGlow").Value;
