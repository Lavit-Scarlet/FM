...
namespace FPenumbra.Particles
{
	public class BloomCircle_Player : Particle
	{
		...
		public override void SetDefaults()
		{
			width = 64;
			height = 64;
			timeLeft = Main.rand.Next(30, 100);
			tileCollide = false;
			...
			randomMulti = Main.rand.NextFloat(0.15f, 0.4f);
		}
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color lightColor)
		{
			...
			spriteBatch.Draw(particle, VisualPosition, new Rectangle(0, 0, width, height), color * opacity, rotation, new Vector2(width, height) / 2, new Vector2(1 + randomMulti, 1 - randomMulti) * size, SpriteEffects.None, 0f);
