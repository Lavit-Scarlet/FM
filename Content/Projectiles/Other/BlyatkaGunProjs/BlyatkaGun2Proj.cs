...
{
	public class BlyatkaGun2Proj : ModProjectile
	{
		...
		public override void Kill(int timeLeft)
		{
            ...
            for (int i = 0; i < n; i++)
            {
                ...
                perturbedSpeed.X *= 6f;
                perturbedSpeed.Y *= 6f;
                Projectile.NewProjectile(Projectile.InheritSource(Projectile),Projectile.Center, perturbedSpeed, ProjectileType<BlyatkaGun3Proj>(), Projectile.damage, 0, Projectile.owner);
            }
		}
	}
}
