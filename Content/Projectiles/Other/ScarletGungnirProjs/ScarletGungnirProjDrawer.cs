...
public struct ScarletGungnirProjDrawer
{
	...
	public void Draw(Projectile proj)
	{
		...
		ScarletGungnirProjDrawer._vertexStrip.PrepareStripWithProceduralPadding(proj.oldPos, proj.oldRot, StripColors, StripWidth, -Main.screenPosition + proj.Size / 2f);
		ScarletGungnirProjDrawer._vertexStrip.DrawTrail();
