	...
	public class IceSpearProj : ModProjectile
	{
		...
		public override bool PreAI() 
		{
			...
			if (Projectile.timeLeft > duration) 
			{
                ...
                Projectile.NewProjectileDirect(Projectile.GetSource_FromAI(), Projectile.Center + Vec, Vec, ModContent.ProjectileType<IceSpearProj2>(), Projectile.damage, Projectile.knockBack, Projectile.owner);
			}
