...
{
    public class HeavenlySpearCuttingProj : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Color color = new Color(216, 246, 253);
            color *= 1f;
            color.A = 0;
            for (int i = 0; i < 1; i++)
            {
                Vector2 Scale = new(Projectile.scale * 3f, Projectile.scale * .86f);//длина, ширина
