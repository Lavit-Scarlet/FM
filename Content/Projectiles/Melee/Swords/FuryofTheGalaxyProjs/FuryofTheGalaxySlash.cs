...
{
    public class FuryofTheGalaxySlash : SlashFuryofTheGalaxy
    {
    ...
    public abstract class SlashFuryofTheGalaxy : ModProjectile
    {
        ...
        public void AttackEffects(Color[] LerpColor)
        {
            if (AttackAI[1] != 0f)
            {
                ...
                Main.graphics.GraphicsDevice.Textures[0] = ModContent.Request<Texture2D>("FM/Assets/Textures/SpacePlaceholder").Value;
                if (Vertex.Count >= 3)
                {
