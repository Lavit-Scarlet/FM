...
{
	public class SwordofFateProj : ModProjectile
	{
		...
		public override void AI()
		{
			...
			bool collding = Collision.SolidCollision(Projectile.position + new Vector2(28 / 2f, 66 / 2f), Projectile.width - 28, Projectile.height - 66);
            if (collding)
            {
