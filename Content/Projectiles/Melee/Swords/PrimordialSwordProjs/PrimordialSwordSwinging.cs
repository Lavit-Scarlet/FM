...
namespace FM.Content.Projectiles.Melee.Swords.PrimordialSwordProjs
{
	public class PrimordialSwordSwinging : ModProjectile 
	{
		...
		public override void AI() 
		{
			...
			{
				Dust coloredDust = Dust.NewDustPerfect(Projectile.Center + dustRotation.ToRotationVector2() * (Main.rand.NextFloat() * 80f * Projectile.scale + 20f * Projectile.scale), 222, dustVelocity * 1f, 100);
		...
		public override bool PreDraw(ref Color lightColor) 
		{
			...
			Color backDarkColor = new Color(255, 252, 144); // Original Excalibur color: Color(180, 160, 60)
			Color middleMediumColor = new Color(231, 178, 28); // Original Excalibur color: Color(255, 255, 80)
			Color frontLightColor = new Color(138, 96, 16); // Original Excalibur color: Color(255, 240, 150)
