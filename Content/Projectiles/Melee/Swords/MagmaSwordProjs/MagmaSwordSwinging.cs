...
{
	public class MagmaSwordSwinging : ModProjectile 
	{
		...
		public override void AI() 
		{
			...
			if (Main.rand.NextFloat() * 2f < Projectile.Opacity) 
			{
				...
				Dust coloredDust = Dust.NewDustPerfect(Projectile.Center + dustRotation.ToRotationVector2() * (Main.rand.NextFloat() * 80f * Projectile.scale + 20f * Projectile.scale), 174, dustVelocity * 1f);
		...
		public override bool PreDraw(ref Color lightColor) 
		{
			...
			Color backDarkColor = new Color(252, 102, 25); // Original Excalibur color: Color(180, 160, 60)
			Color middleMediumColor = new Color(255, 179, 47); // Original Excalibur color: Color(255, 255, 80)
			Color frontLightColor = new Color(255, 215, 70); // Original Excalibur color: Color(255, 240, 150)
