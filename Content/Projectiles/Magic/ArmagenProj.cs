...
{
    public class ArmagenProj : ModProjectile
    {
        private int Counter
		{
        ...
        private void CheckCollision()
        {
			...
			for (int i = 0; i < 12; i++)
			{
				Dust dust = Dust.NewDustPerfect(origin + (dirUnit * shotLength), 219, Vector2.Zero, 0, Color.White, Main.rand.NextFloat(1.0f, 1.5f));
