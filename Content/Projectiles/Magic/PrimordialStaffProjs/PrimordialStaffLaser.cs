...
{
    public class PrimordialStaffLaser : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                Projectile.Center = player.Center + Vector2.Normalize(Projectile.velocity) * 50f;
            }
            ...
            if (AITimer > 2 && AITimer <= 20)
            {
                LaserScale += 0.05f;
            }
            else if (Projectile.timeLeft < 20 || !player.active)
            {
