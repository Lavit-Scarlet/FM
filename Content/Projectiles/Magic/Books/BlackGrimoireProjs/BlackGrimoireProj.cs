...
{
	public class BlackGrimoireProj : ModProjectile
	{
			...
			else if (State == 1)
			{
				...
				if (time >= 4)
				{
					if (Projectile.owner == Main.myPlayer)
					{
						...
						Projectile.NewProjectile(Projectile.GetSource_FromAI(), Projectile.Center, Projectile.velocity * 1.1f, ModContent.ProjectileType<BlackGrimoireShootProj>(), Projectile.damage, Projectile.knockBack, Main.myPlayer, Projectile.whoAmI);
					}
					State = 2;
				}
			}
