...
{
	public class ArmagemBorderProj : ModProjectile
	{
			...
			else if (State == 1)
			{
				...
				if (time >= 4)
				{
					if (Projectile.owner == Main.myPlayer)
					{
						...
						Projectile.NewProjectile(Projectile.GetSource_FromAI(), Projectile.Center, Projectile.velocity, ModContent.ProjectileType<ArmagemLaserProj>(), Projectile.damage, Projectile.knockBack, Main.myPlayer, Projectile.whoAmI);
					}
					State = 2;
				}
			}
