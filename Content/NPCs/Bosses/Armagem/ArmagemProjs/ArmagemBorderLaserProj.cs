...
{
	public class ArmagemBorderLaserProj : ModProjectile
	{
			...
			else if (State == 1)
			{
				...
				if (time >= 4)
				{
					if (Main.myPlayer == Projectile.owner)
						Projectile.NewProjectile(Projectile.GetSource_FromAI(), Projectile.Center, Projectile.velocity, ModContent.ProjectileType<ArmagemBorderLaserShootProj>(), Projectile.damage, Projectile.knockBack, Main.myPlayer, Projectile.whoAmI);
					State = 2;
				}
				Projectile.netUpdate = true;
			}
