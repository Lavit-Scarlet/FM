...
namespace FM.Globals.ArmorGlowExtra
{
    ...
    public class OnBodyDraw
    {
        ...
        public static void RegisterBodies()
        {
            ...
            Mod mod = FM.Instance;
            OnBodyDraw body = new(Request<Texture2D>("FM/Content/Items/Armor/PowerArmor/PowerBreastplate_Body_Glow", immediate).Value);
            BodyDictionary.Add(EquipLoader.GetEquipSlot(mod, "PowerBreastplate", EquipType.Body), body);
        }
    }
}