...
namespace FM.Globals.ArmorGlowExtra
{
    ...
    public class OnLegDraw
    {
        ...
        public static void RegisterLegs()
        {
            ...
            Mod mod = FM.Instance;
            OnLegDraw leg = new(Request<Texture2D>("FM/Content/Items/Armor/PowerArmor/PowerBoots_Legs_Glow", immediate).Value, Request<Texture2D>("FM/Content/Items/Armor/PowerArmor/PowerBoots_Legs_Glow", immediate).Value);
            LegDictionary.Add(EquipLoader.GetEquipSlot(mod, "PowerBoots", EquipType.Legs), leg);
        }
    }
}